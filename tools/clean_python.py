...
class Autopep8Task(CleanupTask):
    ...
    def __init__(self, name, pep8_classes):
        self.__cmd = ["autopep8-3", "--jobs", "4", "--aggressive",
...
def _get_tests():
    ...
    autopep8_intendation_tabs = Autopep8Task(
    ...
    autopep8_blank_lines = Autopep8Task(
        "Blank line", "E3,W3")
    autopep8_intendation_in_comments = Autopep8Task(
        "Intendation in comments", "E11")
    autopep8_intendation_in_code = Autopep8Task(
        "Intendation in code", "E1,W1")

    # please note: the order is important here!
    return [unify_line_endings,
            autopep8_intendation_tabs,
            ...
            autopep8_intendation_in_comments,
            autopep8_intendation_in_code,
            ]
